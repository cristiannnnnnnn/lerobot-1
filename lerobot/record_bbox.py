...
def record_loop(
    ...
    pick, place, norm_pick, norm_place, pick_labels, place_labels = get_target_bbox(observation["top"])
        ...
        if display_data:
            for obs, val in observation.items():
                if isinstance(val, float):
                    ...
                    if "top" in obs:
                        val = np.array(plot_bbox(observation["top"], pick_bbox=pick_t, place_bbox=place_t))
